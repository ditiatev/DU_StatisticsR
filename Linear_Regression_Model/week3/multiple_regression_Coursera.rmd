...
```{r p-val-select}
m_second <- lm(score ~ rank + ethnicity + gender + language + age + cls_perc_eval 
...
```{r adj-rsq-select}
m <- lm(score ~ rank + ethnicity + language + age + cls_perc_eval 
             + cls_students + cls_level + cls_profs + cls_credits + bty_avg 
             + pic_outfit + pic_color, data = evals)
print(paste('gender: ',(summary(m)$adj.r.squared - summary(m_full)$adj.r.squared)))

m <- lm(score ~ rank + ethnicity + gender + age + cls_perc_eval 
             + cls_students + cls_level + cls_profs + cls_credits + bty_avg 
             + pic_outfit + pic_color, data = evals)
print(paste('language: ',(summary(m)$adj.r.squared - summary(m_full)$adj.r.squared)))

m <- lm(score ~ rank + ethnicity + gender + language + cls_perc_eval 
             + cls_students + cls_level + cls_profs + cls_credits + bty_avg 
             + pic_outfit + pic_color, data = evals)
print(paste('age: ',(summary(m)$adj.r.squared - summary(m_full)$adj.r.squared)))

m <- lm(score ~ rank + ethnicity + gender + language + age 
             + cls_students + cls_level + cls_profs + cls_credits + bty_avg 
             + pic_outfit + pic_color, data = evals)
print(paste('cls_perc_eval: ',(summary(m)$adj.r.squared - summary(m_full)$adj.r.squared)))

m <- lm(score ~ rank + ethnicity + gender + language + age + cls_perc_eval 
             + cls_level + cls_profs + cls_credits + bty_avg 
             + pic_outfit + pic_color, data = evals)
print(paste('cls_students: ',(summary(m)$adj.r.squared - summary(m_full)$adj.r.squared)))

m <- lm(score ~ rank + ethnicity + gender + language + age + cls_perc_eval 
             + cls_students + cls_profs + cls_credits + bty_avg 
             + pic_outfit + pic_color, data = evals)
print(paste('cls_level: ',(summary(m)$adj.r.squared - summary(m_full)$adj.r.squared)))

m <- lm(score ~ rank + ethnicity + gender + language + age + cls_perc_eval 
             + cls_students + cls_level + cls_credits + bty_avg 
             + pic_outfit + pic_color, data = evals)
print(paste('cls_profs: ',(summary(m)$adj.r.squared - summary(m_full)$adj.r.squared)))

m <- lm(score ~ rank + ethnicity + gender + language + age + cls_perc_eval 
             + cls_students + cls_level + cls_profs + bty_avg 
             + pic_outfit + pic_color, data = evals)
print(paste('cls_credits: ',(summary(m)$adj.r.squared - summary(m_full)$adj.r.squared)))

m <- lm(score ~ rank + ethnicity + gender + language + age + cls_perc_eval 
             + cls_students + cls_level + cls_profs + cls_credits 
             + pic_outfit + pic_color, data = evals)
print(paste('bty_avg: ',(summary(m)$adj.r.squared - summary(m_full)$adj.r.squared)))

m <- lm(score ~ rank + ethnicity + gender + language + age + cls_perc_eval 
             + cls_students + cls_level + cls_profs + cls_credits + bty_avg 
             + pic_color, data = evals)
print(paste('pic_outfit: ',(summary(m)$adj.r.squared - summary(m_full)$adj.r.squared)))

m <- lm(score ~ rank + ethnicity + gender + language + age + cls_perc_eval 
             + cls_students + cls_level + cls_profs + cls_credits + bty_avg 
             + pic_color, data = evals)
print(paste('pic_color: ',(summary(m)$adj.r.squared - summary(m_full)$adj.r.squared)))
```
