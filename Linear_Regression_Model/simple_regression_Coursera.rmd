...
713 - (m1$coefficients[[1]] + m1$coefficients[[2]]*5579)
```
...
m1_1 <- lm(runs ~ at_bats, data = mlb11)
m1_2 <- lm(runs ~ hits, data = mlb11)
m1_3 <- lm(runs ~ wins, data = mlb11)
m1_4 <- lm(runs ~ bat_avg, data = mlb11)
...
m1_new_obs <- lm(runs ~ new_obs, data = mlb11)
m1_new_slug <- lm(runs ~ new_slug, data = mlb11)
m1_new_onbase <- lm(runs ~ new_onbase, data = mlb11)
