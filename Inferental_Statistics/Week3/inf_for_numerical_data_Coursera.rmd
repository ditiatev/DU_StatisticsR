...
# younger mother
nc <- nc %>%
  mutate(younger_mother = if_else(mage <= 23, "Young", "In ages"))

inference(y = weight, x = younger_mother, data = nc, statistic = "mean", type = "ht", null = 0, 
          alternative = "twosided", method = "theoretical")
```
...
```{r pick-your-own}
inference(y = weight, x = marital, data = nc, statistic = "mean", type = "ci", 
