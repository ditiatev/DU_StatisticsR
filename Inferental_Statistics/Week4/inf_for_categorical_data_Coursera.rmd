...
rus12 <- atheism %>%
  filter(nationality == "Russian Federation" , atheism$year == "2012")
pl12 <- atheism %>%
...
```{r}
inference(y = response, data = rus12, 
          statistic = "proportion", type = "ci", method = "theoretical", success = "atheist")
```

### "Poland"

```{r}
inference(y = response, data = pl12, statistic = "proportion", type = "ci", method = "theoretical", success = "atheist")
```
...
inference(y = response, x = as.factor(year), data = spain_05_12, 
...
inference(y = response, x = as.factor(year), data = us_05_12, 
          statistic = "proportion", type = "ht",
          null = 0, alternative = "twosided",
          method = "theoretical", success = "atheist")
```
